...
public class EventService {
    ...
    public Event updateEvent(String eventId, Event eventDetails) throws IOException {
        ...
        try {
            ...
            if (optionalEvent.isPresent()) {
                ...
                event.setOwnerId(eventDetails.getOwnerId());
    ...
    public void stopSimulation(String id, boolean mode) throws IOException{
        lock.lock();
        try {
            Sim.stopSimulation(mode);
        } finally {
            lock.unlock();
        }
    }
...
/// //////////////////////////////////////// add time to that update stings in console and save a logs in the backend ////////////////////////////////////////
/// /////////////////////////////////////////// give real time variables to the front end to display //////////////////////////////////
/// /////////////////////////////////////////// add stop sim button //////////////////////////////////////////////////
/// ///////////////////////////////////////// try to save some of these vars   ///////////////////////////////////////////
/////////////////////////////////////////////try to save a history of sims to event  ////////////////////////////
/////////////////////////////////////////////////////////////// when editing event details make the old owner id is removed from vendor list and the new owner is added //////////////////////////////////////////////////////////////